...
import fr.theialand.insitu.dataportal.api.geonetwork.handler.auth.Authentication;
import fr.theialand.insitu.dataportal.api.geonetwork.handler.auth.HttpBasicAuth;
import fr.theialand.insitu.dataportal.api.geonetwork.handler.auth.HttpBearerAuth;
import fr.theialand.insitu.dataportal.api.geonetwork.handler.auth.ApiKeyAuth;
...
@Component("fr.theialand.insitu.dataportal.api.geonetwork.handler.ApiClient")
public class ApiClient {
    ...
    private String basePath = "http://localhost:8080/geonetwork/srv/api";
