...
/**
 * SearchResponseOfv2FullStructure
 */
@JsonPropertyOrder({
  SearchResponseOfv2FullStructure.JSON_PROPERTY_FACETS,
  SearchResponseOfv2FullStructure.JSON_PROPERTY_HISTOGRAMS_MAP_VALUE_TYPE_DUMMY,
  SearchResponseOfv2FullStructure.JSON_PROPERTY_REQUEST,
  SearchResponseOfv2FullStructure.JSON_PROPERTY_RESULTS,
  SearchResponseOfv2FullStructure.JSON_PROPERTY_TOTAL
})
...
public class SearchResponseOfv2FullStructure {
  ...
  public SearchResponseOfv2FullStructure facets(List<FacetResult> facets) {
    
    this.facets = facets;
    return this;
  }

  public SearchResponseOfv2FullStructure addFacetsItem(FacetResult facetsItem) {
    if (this.facets == null) {
  ...
  **/
  ...
  public SearchResponseOfv2FullStructure histogramsMapValueTypeDummy(FacetResult histogramsMapValueTypeDummy) {
  ...
  **/
  ...
  public SearchResponseOfv2FullStructure request(V2SearchRequest request) {
  ...
  **/
  ...
  public SearchResponseOfv2FullStructure results(List<SearchResultOfv2FullStructure> results) {
    
    this.results = results;
    return this;
  }

  public SearchResponseOfv2FullStructure addResultsItem(SearchResultOfv2FullStructure resultsItem) {
  ...
  **/
  ...
  public SearchResponseOfv2FullStructure total(Long total) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SearchResponseOfv2FullStructure searchResponseOfv2FullStructure = (SearchResponseOfv2FullStructure) o;
    return Objects.equals(this.facets, searchResponseOfv2FullStructure.facets) &&
        Objects.equals(this.histogramsMapValueTypeDummy, searchResponseOfv2FullStructure.histogramsMapValueTypeDummy) &&
        Objects.equals(this.request, searchResponseOfv2FullStructure.request) &&
        Objects.equals(this.results, searchResponseOfv2FullStructure.results) &&
        Objects.equals(this.total, searchResponseOfv2FullStructure.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchResponseOfv2FullStructure {\n");
