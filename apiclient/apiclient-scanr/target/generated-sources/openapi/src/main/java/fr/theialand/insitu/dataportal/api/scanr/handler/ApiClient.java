package fr.theialand.insitu.dataportal.api.scanr.handler;
...
import fr.theialand.insitu.dataportal.api.scanr.handler.auth.Authentication;
import fr.theialand.insitu.dataportal.api.scanr.handler.auth.HttpBasicAuth;
import fr.theialand.insitu.dataportal.api.scanr.handler.auth.HttpBearerAuth;
import fr.theialand.insitu.dataportal.api.scanr.handler.auth.ApiKeyAuth;
...
@Component("fr.theialand.insitu.dataportal.api.scanr.handler.ApiClient")
public class ApiClient {
    ...
    private String basePath = "https://scanr-api.enseignementsup-recherche.gouv.fr/api";
